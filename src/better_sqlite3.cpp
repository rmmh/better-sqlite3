...
namespace Data
{
#line 83 "./src/util/data.lzz"
  static char const EXPAND = 2;
}
#line 79 "./src/util/data.lzz"
namespace Data
{
#line 84 "./src/util/data.lzz"
